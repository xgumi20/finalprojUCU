...
public class musicopti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_musicopti);
        ...
        songs = MediaPlayer.create(this, R.raw.opti);
        ...
        s.setOnClickListener(v -> {
            ...
            songs = MediaPlayer.create(musicopti.this, R.raw.mild);
        });

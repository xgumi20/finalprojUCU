...
public class musichigh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_musichigh);
        ...
        songs = MediaPlayer.create(this, R.raw.high);
        ...
        s.setOnClickListener(v -> {
            ...
            songs = MediaPlayer.create(musichigh.this, R.raw.high);
        });
